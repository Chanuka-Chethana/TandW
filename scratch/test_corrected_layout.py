...
# Date inside heart (clean, no badge, centered at 48% / 49%)
...
# Dedicated Button below hand heart only
btn_w, btn_h = 240, 44
btn_x = (W - btn_w) // 2
btn_y = hy + nh + 12

draw.rounded_rectangle([btn_x, btn_y, btn_x + btn_w, btn_y + btn_h], radius=22, fill=(120, 16, 38, 220), outline=(255, 225, 140, 255), width=2)
draw.text((W // 2, btn_y + btn_h // 2), "📅  SAVE TO CALENDAR", font=font_btn, fill=(255, 250, 230), anchor="mm")

out_path = "scratch/layout_clean_corrected.png"
img.save(out_path)
